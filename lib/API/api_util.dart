class ApiUtil {
  ...
  static const String activate_url = base_url + '/activate';
  static const String update_profile_url = base_url + '/update-profile';
  static const String activate_email_url = base_url + '/activate-email';
  static const String forget_url = base_url + '/forget';
  static const String current_userurl = base_url + '/current-user';
